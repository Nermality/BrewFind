package coldcoffee.brewfind.Configuration;
...
import coldcoffee.brewfind.Repositories.RepositoryPackage;
...
public class SpringMongoConfig extends AbstractMongoConfiguration{
	...
	public Mongo mongo() throws Exception {
		return new MongoClient("52.35.37.107", 27017);
	}
	
	// Defined so it knows where to find the @Document objects
	@Override
    protected String getMappingBasePackage() {
	    return "coldcoffee.brewfind.Objects";
	}
}
