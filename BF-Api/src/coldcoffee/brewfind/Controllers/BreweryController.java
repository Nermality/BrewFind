...
public class BreweryController {
	...
	public BrewFindResponse getList(){
		...
		List<? extends BrewFindObject> bList;
		try {
			bList = breweryService.getList();
		} catch (MongoTimeoutException e) {
			e.printStackTrace();
			return new BrewFindResponse(12, "Mongo instance unavailable");
		}
	...
	public BrewFindResponse updateBrewery(String json){
		...
		try {
			...
			return new BrewFindResponse(15, "Numbers sent as strings");
		}
